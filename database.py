...
# As pastas 'materiais/' e 'orcamentos/' já vieram criadas no projeto
# (junto com os arquivos dos colegas responsáveis por cada parte), então
# os JSONs são salvos dentro delas. 'clientes/' e 'medidas/' seguem o
# mesmo padrão, criadas automaticamente na primeira gravação.
...
def _dict_para_orcamento(dado, materiais_disponiveis):
    ...
    if material is None:
        # Material não existe mais na lista atual: recria com preço 0
        # para não perder o orçamento salvo.
...
def _medida_para_dict(medida):
    # A classe Metragem (calculos.py) usa atributos "privados" com
    # name mangling. Por isso acessamos pelos nomes internos gerados
    # pelo Python: _Metragem__descricao, _Metragem__largura, etc.
    return {
...
# =====================================================================
# TESTE MANUAL (python database.py)
# =====================================================================
